...
def build_digest_prompt(
    ...
    header = (
        ...
        "Think hard about the evidence and select only the top five coffees in total across all "
        "reports.\n"
        "If fewer than five coffees meet the bar, select fewer and say so explicitly; do not "
        "pad the list.\n"
        "Do not mention or recommend any coffees outside the selected top five.\n"
        "Write a digest that synthesizes the key recommendations across all reports.\n"
        "Include an accessible introduction for readers with limited knowledge of how to "
        "choose top-tier coffee.\n"
        "Provide verbose, educational reasoning for each recommendation, explain unfamiliar "
        "terms, and teach the reader how to recognize top-tier signals.\n"
        "Do not be afraid to be long if it improves clarity and usefulness.\n"
        "Include: overall summary, top-five coffees and why, any roasters with no strong picks, "
